...
function finish() {
	...
	$(".control_group").each(function () {
		...
		$project_award = $("#project_award").val();
...
function btn_plus_award() {
	$award = $("#projectAward>div").eq(0);
	$award = $award.clone();
	$award.children(".controls").children(".award").val("");
	//$award.children(".controls").children(".uploadfile").val("");
	$("#projectAward").append($award);
}
...
function pass() {
	...
	pass += $('#enter_year').val().trim() != '' ? message($('.enter_year .help-inline'), '') : message($('.enter_year .help-inline'), '不能為空');
...
//	pass += $('#project_award').val().trim() != '' ? message($('.p_award .help-inline'), '') : message($('.p_award .help-inline'), '不能為空');
